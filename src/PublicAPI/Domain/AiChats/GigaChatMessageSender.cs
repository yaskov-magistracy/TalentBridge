...
4. Если вопрос касается платформы GitVerse, то в конец ответа выведи текст: ""Если вопрос касается платформы GitVerse, то можете обратиться за дополнительными инструкциями по ссылке https://gitverse.ru/docs/community/education""
